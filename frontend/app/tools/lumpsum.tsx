  ...
  return (
    ...
    >
      <View style={styles.header}>
        <TouchableOpacity testID="lumpsum-back-btn" onPress={() => router.back()} hitSlop={10}>
          <Feather name="arrow-left" size={24} color={colors.textPrimary} />
        </TouchableOpacity>
        <Text style={[typography.h3, { marginLeft: spacing.p3 }]}>Lumpsum Calculator</Text>
      </View>
      <ScrollView contentContainerStyle={{ padding: spacing.p6 }}>
        <Text style={typography.overline}>INVESTMENT AMOUNT (₹)</Text>
        <TextInput testID="lumpsum-amount" style={styles.input} value={amount} onChangeText={setAmount} keyboardType="decimal-pad" />

        <Text style={[typography.overline, { marginTop: spacing.p4 }]}>YEARS</Text>
        <TextInput testID="lumpsum-years" style={styles.input} value={years} onChangeText={setYears} keyboardType="decimal-pad" />

        <Text style={[typography.overline, { marginTop: spacing.p4 }]}>EXPECTED RETURN (% / yr)</Text>
        <TextInput testID="lumpsum-rate" style={styles.input} value={rate} onChangeText={setRate} keyboardType="decimal-pad" />

        <TouchableOpacity testID="lumpsum-calc-btn" style={styles.btn} onPress={calc} disabled={loading}>
        ...
        {result && (
          <View style={styles.resultCard} testID="lumpsum-result">
